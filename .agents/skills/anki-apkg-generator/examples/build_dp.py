"""
Example: Dynamic Programming APKG generator using apkg_builder.

Run from the topic directory (where images live):
    cd 算法/动态规划
    python ..\..\.claude\skills\anki-apkg-generator\examples\build_dp.py
...
# Add the skill's scripts directory to import path
